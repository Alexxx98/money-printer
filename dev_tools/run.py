...
def main() -> None:
    ...
    if module == "gpt":
        ...
        if func == "generate_text":
            ...
            print(gpt.generate_text(prompt, web_search))
    ...
    # Pexels module methods 
        ...
        if func == "search_for_pohoto":
            ...
            print(pexels.search_for_photo(query, curated))

        elif func == "search_for_video":
            popular: bool = args[1] if len(args) > 1 else False
            print(pexels.search_for_video(query, popular))
